...
export default function AddModalCatalogPage() {
  return (
    <>
      <Head>
        <title>AddScheduleModal - UI Catalog</title>
        <link rel="stylesheet" href="/styles.css" />
      </Head>
      <CatalogLayout currentPath="/catalog/add-modal">
        <div>
          <h1 class="text-3xl font-bold text-gray-900 mb-4">AddScheduleModal</h1>
          <p class="text-lg text-gray-600 mb-8">
            新しい予定を追加するためのモーダルダイアログ。
            テキスト入力と画像アップロードの2つの方法で予定を追加できます。
          </p>
